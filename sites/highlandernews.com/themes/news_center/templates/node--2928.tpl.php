...
$param12=array('UserName'=>"$username");
    ...
    else if($response12->GetPublicationIDResult== 99)
    {
...
<body>
  ...
  <section class="container">
    ...
    <div class="login-help" style="color:#000">
     <p style="color:#000">Forgot your password? <a href="http://etypesrvices2.net/highlander/forgot-password" style="color:#000">Click here </a>.</p>

   ...
   // echo "<pre>";
    ...
    //  echo "</pre>";
      ...
      ?>
       <form  name="planform" method="POST" action="http://etypesrvices2.net/highlander/node/2924" enctype="multipart/form-data">
<fieldset>
    <style>
...
<div class="header1" >
<div class="headertop">
<h4 style="background: gray;line-height: 2em;font-size: 16px;margin-right: 33px;"> <center>CHOOSE THE SUBSCRIPTION THAT'S RIGHT FOR YOU</center></h4></div>
<div class="headerdown">
<div class="headerdl" style="height:200px;">


<img src="http://etypesrvices2.net/highlander/sites/default/files/Banner.jpg"  style="width:95%; height:140px;">
...
<br/>
<strong>Already a print subscriber? <a href="http://etypesrvices2.net/highlander/node/2927" style="color:red">Fill out this form</a> to activate your digital subscription. Once your print subscription is verified, your user account will be enabled.</strong>
             </p>
...
<strong><h3>Highlander News  </h3></strong>
...
<?php
              ...
              <input type="hidden" name="Publication_Id" value="99">

...
<script type="text/javascript" src="/sites/wimberleyview.com/Slider_ads/jquery-1.2.6.min.js"></script>
  <?php print $head; ?>
  <title><?php print $head_title; ?></title>
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0, minimum-scale=1, user-scalable=no" />
  <meta property="og:image" content=http://wimberleyview.com/sites/wimberley/files/Wimberly_View.jpg>    
  <?php print $styles; ?>
  <?php print $scripts; ?>
</head>

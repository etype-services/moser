...
$param12=array('UserName'=>"$username");
    ...
    else if($response12->GetPublicationIDResult== 2100)
    {
...
display:none;
  ...
  <section class="container">
    ...
    <div class="login-help" style="color:#000">
     <p style="color:#000">Forgot your password? <a href="http://www.wimberleyview.com/content/forgot-password" style="color:#000">Click here </a>.</p>

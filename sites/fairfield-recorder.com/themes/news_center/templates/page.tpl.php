...
<div id="page-wrapper" class="container" ><div id="page">
  ...
  <div id="header"><div class="section clearfix">
    ...
    <?php if ($logo): ?>
      <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo"><img src="<?php print $logo; ?>" style="width: 700px;height: 155px;" alt="<?php print t('Home'); ?>" /></a>
	  <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="mobile-logo"><img src="<?php print $base_path; ?><?php print $directory; ?>/logo_mobile.png" style="width:292px;height: 83px;" alt="<?php print t('Home'); ?>" /></a>
    <?php endif; ?>
